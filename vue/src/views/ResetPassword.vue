        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <div class="px-8 mb-4 text-center">
            ...
            <p class="mb-4 text-sm text-gray-700">
              Masukan Email dan Kami Akan Mengirimkan Token Untuk Mengatur Ulang
              Password.
            </p>
          </div>
          ...
          <!-- FORM -->
          <div>
            <form class="space-y-4 md:space-y-6" @submit="validasiToken">
              <div>
                <form-title judul="Token"></form-title>
                <form-text
                  id="token"
                  type="text"
                  v-model="user.token"
...
const { sentToken, validateToken } = useAuth();
const user = reactive({
  email: "",
  token: "",
});
